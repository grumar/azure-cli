...
def load_arguments(self, _):
    ...
    for scope in ['webapp', 'functionapp']:
        ...
        with self.argument_context(scope + ' config set') as c:
            ...
            c.argument('net_framework_version', help="The version used to run your web app. If using .NET Framework, e.g., for .NET 4.6 use 'v4.0' and for .NET 3.5 use 'v3.0'. If using .NET/.NET Core e.g., for .NET6 use 'v6.0' ")
